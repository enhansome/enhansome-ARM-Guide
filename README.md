...
[Compute Library](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,192 | 🐛 6 | 🌐 C++ | 📅 2026-09-09 is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,329 | 🐛 215 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,138 | 🐛 435 | 🌐 Rust | 📅 2026-09-13 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Servo](https://github.com/servo/servo) ⭐ 37,963 | 🐛 3,199 | 🌐 Rust | 📅 2026-09-13 is a prototype web browser engine written in the Rust language.
