...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,187 | 🐛 446 | 🌐 Rust | 📅 2026-09-18 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Servo](https://github.com/servo/servo) ⭐ 38,017 | 🐛 3,207 | 🌐 Rust | 📅 2026-09-20 is a prototype web browser engine written in the Rust language.
