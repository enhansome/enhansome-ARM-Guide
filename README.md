...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,368 | 🐛 218 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[Asahi Linux Wiki](https://github.com/AsahiLinux/docs/wiki) ⭐ 2,301 | 🐛 19 | 🌐 HTML | 📅 2026-08-30
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,729 | 🐛 128 | 🌐 Java | 📅 2026-09-13 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,517 | 🐛 1,675 | 🌐 Rust | 📅 2026-09-25 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,234 | 🐛 449 | 🌐 Rust | 📅 2026-09-25 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Rocket](https://github.com/SergioBenitez/Rocket) ⭐ 25,782 | 🐛 91 | 🌐 Rust | 📅 2025-12-28 is an async web framework for Rust with a focus on usability, security, extensibility, and speed.
...
[Servo](https://github.com/servo/servo) ⭐ 38,036 | 🐛 3,230 | 🌐 Rust | 📅 2026-09-25 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,366 | 🐛 397 | 🌐 Rust | 📅 2026-09-25 is a Python Interpreter written in Rust.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,215 | 🐛 38 | 🌐 Rust | 📅 2026-09-21 is a small set of exercises to get you used to reading and writing Rust code.
...
[Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) ⭐ 9,670 | 🐛 198 | 🌐 Rust | 📅 2026-09-22 is an open-source Linux-based operating system meant for hosting containers. Bottlerocket focuses on security and maintainability, providing a reliable, consistent, and safe platform for container-based workloads.
