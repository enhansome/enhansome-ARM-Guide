...
[Asahi Linux Wiki](https://github.com/AsahiLinux/docs/wiki) ⭐ 2,302 | 🐛 19 | 🌐 HTML | 📅 2026-08-30
...
[Apache Arrow](https://github.com/apache/arrow) ⭐ 17,158 | 🐛 2,545 | 🌐 C++ | 📅 2026-09-26 is a development platform for in-memory analytics. It contains a set of technologies that enable big data systems to process and move data fast. Arrow's libraries are available for C, C++, C#, Go, Java, JavaScript, MATLAB, Python, R, Ruby, and Rust.

[Wasmer](https://wasmer.io/) enables super lightweight containers based on [WebAssembly](https://webassembly.org/) that can run anywhere such as the Desktop to the Cloud and IoT devices, and also embedded in [any programming language](https://github.com/wasmerio/wasmer#language-integrations) ⭐ 21,092 | 🐛 281 | 🌐 Rust | 📅 2026-09-26.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,243 | 🐛 446 | 🌐 Rust | 📅 2026-09-26 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,878 | 🐛 1,832 | 🌐 Rust | 📅 2026-09-26 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Servo](https://github.com/servo/servo) ⭐ 38,041 | 🐛 3,234 | 🌐 Rust | 📅 2026-09-26 is a prototype web browser engine written in the Rust language.
...
[RustPython](https://github.com/RustPython/RustPython) ⭐ 22,368 | 🐛 400 | 🌐 Rust | 📅 2026-09-26 is a Python Interpreter written in Rust.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,225 | 🐛 38 | 🌐 Rust | 📅 2026-09-21 is a small set of exercises to get you used to reading and writing Rust code.
